...
var ball2active = false; // flag

//ball bevegelse
var player2BallMoveX = 5;
var player2BallMoveY = -5;
...
function update(){
 ...
 /*    if(ball.y + ball.my < ball.r ){
   ...
   else if(p1b.y + p2b.m < p1b.r ){
    p1b.n = -p1b.n;
   } else if(p1b.y + p1b.m > canvas.height - p1b.r){
    p1b.n = -p1b.n;
    }
    //ball1 x-kollisjon med høyre siden av canvas
   ...
   //player2 ball kollisjon MED ball fra player1
   if(
    ...
    //ball2 x-kollisjon med venstrew siden av canvas
